...
//	go run ./cmd/create-integration -project=mlab-sandbox -integration-id=my-integration -integration-description="Test integration" -key-description="Initial API key"
//	go run ./cmd/create-integration -project=mlab-sandbox -integration-id=my-integration -key-id=ki_custom -key-description="Custom key ID"
package main
...
func main() {
	...
	err = manager.CreateIntegration(ctx, *integrationID, *integrationDescription)
